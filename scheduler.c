...
void exek(){
	...
	for (i = 0; i < CORE; i++)
	{
		for (j = 0; j < HARI; j++)
		{
			...
			{
				if(prozesagailu.corekop[i].harikop[j].erabilgarri == 0 && ilara.buff[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].une]].pid != 0){
					if (ilara.buff[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].une]].erabilera == 0)
					{
						...
						ilara.buff[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].une]].aldatu = 0;
						...
						printf("%d prozesua exekutatzen, %d coreko %d harian.\n", ilara.buff[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait1[prozesagailu.corekop[i].nun].une]].pid, i, j);
					}
			...
			{
				if (ilara.buff[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].une]].erabilera == 0)
				{
					ilara.buff[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].une]].egoera = 2;
				ilara.buff[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].une]].erabilera = 1;
				ilara.buff[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].une]].aldatu = 0;
				prozesagailu.corekop[i].harikop[kont].prozesua = prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].une];
				printf("%d prozesua exekutatzen, %d coreko %d harian.\n", ilara.buff[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].zerrenda[prozesagailu.corekop[i].wait2[prozesagailu.corekop[i].nun].une]].pid, i, j);
				}
			}
